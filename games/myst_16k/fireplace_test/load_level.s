...
level_bank_and_high:
	...
	.byte	(0<<5) | (>imager_w_data_zx02)		; 20 = imager_w
	.byte	(0<<5) | (>hilltop_s_data_zx02)		; 21 = hilltop_s
	.byte	(0<<5) | (>hilltop_n_data_zx02)		; 22 = hilltop_n
	.byte	(0<<5) | (>hilltop_e_data_zx02)		; 23 = hilltop_e
	.byte	(0<<5) | (>arrival_e_data_zx02)		; 24 = arrival_e
	.byte	(0<<5) | (>clock_n_data_zx02)		; 25 = clock_n

	.byte	(1<<5) | (>shortsteps_w_data_zx02)	; 26 = shortsteps_w
	.byte	(1<<5) | (>gear_s_data_zx02)		; 27 = gear_s
	.byte	(1<<5) | (>library_s_data_zx02)		; 28 = library_s
	.byte	(1<<5) | (>arrival_s_data_zx02)		; 29 = arrival_s
	.byte	(1<<5) | (>arrival_w_data_zx02)		; 30 = arrival_w
	.byte	(1<<5) | (>hill_w_data_zx02)		; 31 = hill_w

	.byte	(2<<5) | (>library_w_data_zx02)		; 32 = library_w
	.byte	(2<<5) | (>library_e_data_zx02)		; 33 = library_e
	.byte	(2<<5) | (>steps_s_data_zx02)		; 34 = steps_s
	.byte	(3<<5) | (>shack_s_data_zx02)		; 35 = shack_s
	.byte	(3<<5) | (>cabin_path_s_data_zx02)	; 36 = cabin_path_s
	.byte	(3<<5) | (>cabin_path_n_data_zx02)	; 37 = cabin_path_n
	.byte	(3<<5) | (>library_sw_data_zx02)	; 38 = library_sw
	.byte	(3<<5) | (>library_se_data_zx02)	; 39 = library_se
	.byte	(3<<5) | (>burnt_book_data_zx02)	; 40 = burnt_book
	.byte	(3<<5) | (>imager_e_data_zx02)		; 41 = imager_e
	.byte	(5<<5) | (>shack_n_data_zx02)		; 42 = shack_n

	.byte	(4<<5) | (>dni_n_data_zx02)		; 43 = dni_n
	.byte	(4<<5) | (>dni_e_data_zx02)		; 44 = dni_e
	.byte	(4<<5) | (>trapped_data_zx02)		; 45 = trapped
	.byte	(4<<5) | (>dock_s_data_zx02)		; 46 = dock_s
	.byte	(4<<5) | (>dentist_e_data_zx02)		; 47 = dentist_e
	.byte	(4<<5) | (>rocket_s_data_zx02)		; 48 = rocket_s
	.byte	(4<<5) | (>pool_s_data_zx02)		; 49 = pool_s
...
level_compress_data_low:
	...
	.byte	<imager_w_data_zx02			; 20 = imager_w
	.byte	<hilltop_s_data_zx02			; 21 = hilltop_s
	.byte	<hilltop_n_data_zx02			; 22 = hilltop_n
	.byte	<hilltop_e_data_zx02			; 23 = hilltop_e
	.byte	<arrival_e_data_zx02			; 24 = arrival_e
	.byte	<clock_n_data_zx02			; 25 = clock_n

	.byte	<shortsteps_w_data_zx02			; 26 = shortsteps_w
	.byte	<gear_s_data_zx02			; 27 = gear_s
	.byte	<library_s_data_zx02			; 28 = library_s
	.byte	<arrival_s_data_zx02			; 29 = arrival_s
	.byte	<arrival_w_data_zx02			; 30 = arrival_w
	.byte	<hill_w_data_zx02			; 31 = hill_W

	.byte	<library_w_data_zx02			; 32 = library_w
	.byte	<library_e_data_zx02			; 33 = library_e
	.byte	<steps_s_data_zx02			; 34 = steps_s

	.byte	<shack_s_data_zx02			; 35 = shack_s
	.byte	<cabin_path_s_data_zx02			; 36 = cabin_path_s
	.byte	<cabin_path_n_data_zx02			; 37 = cabin_path_n
	.byte	<library_sw_data_zx02			; 38 = library_sw
	.byte	<library_se_data_zx02			; 39 = library_se
	.byte	<burnt_book_data_zx02			; 40 = burnt_book
	.byte	<imager_e_data_zx02			; 41 = imager_e
	.byte	<shack_n_data_zx02			; 42 = shack_n

	.byte	<dni_n_data_zx02			; 43 = dni_n
	.byte	<dni_e_data_zx02			; 44 = dni_e
	.byte	<trapped_data_zx02			; 45 = trapped
	.byte	<dock_s_data_zx02			; 46 = dock_S
	.byte	<dentist_e_data_zx02			; 47 = dentist_e
	.byte	<rocket_s_data_zx02			; 48 = rocket_s
	.byte	<pool_s_data_zx02			; 49 = pool_s
