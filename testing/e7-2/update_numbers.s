...
; 375
	...
	; copy to zero page
high_right_font_loop:
	lda	(INL),Y							; 5+
	sta	DIGIT2_DATA_0,X					; 4
	iny								; 2
	dex								; 2
	bpl	high_right_font_loop					; 2/3
								;===========
								; 16*7 = 112
								;	-1
...
low_right_d1_font_loop:
	lda	(INL),Y			; copy font data to zero page	; 5+
	sta	DIGIT1_DATA_0,X					; 4
	iny								; 2
	dex								; 2
	bpl	low_right_d1_font_loop					; 2/3
								;===========
								; 16*7 = 112
								;	-1
